...
def mlpLayer2(x_train,y_train,x_test,y_test,batch_size,num_classes,epochs):
	model = Sequential()
	model.add(Dense(512, activation='relu', input_shape=(784,)))
	model.add(Dropout(0.2))
...
# for three hidden layer 
def mlpLayer3(x_train,y_train,x_test,y_test,batch_size,num_classes,epochs):
	model = Sequential()
	model.add(Dense(512, activation='relu', input_shape=(784,)))
	model.add(Dropout(0.2))
	model.add(Dense(512, activation='relu'))	# hidden layer 1
