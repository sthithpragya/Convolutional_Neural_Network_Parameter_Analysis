...
def computeAndPlot(epochs,folderName):
	...
	history2, score2 = cnnMask5(x_train,y_train,x_test,y_test,batch_size,num_classes,epochs,input_shape)
	history3, score3 = cnnMask10(x_train,y_train,x_test,y_test,batch_size,num_classes,epochs,input_shape)
	...
	plt.ylabel('Accuracy')
	plt.xlabel('Epoch')
	plt.legend(['Train1', 'Test1','Train5', 'Test5','Train10', 'Test10'],loc='upper center', bbox_to_anchor=(0.5, -0.05),ncol=6)
	fileNameAccuracy = folderName + 'CNN_Mask5andMask10_accuracy_e'+str(epochs)+'.png'
	...
	plt.xlabel('Epoch')
	plt.legend(['Train1', 'Test1','Train5', 'Test5','Train10', 'Test10'], loc='upper center', bbox_to_anchor=(0.5, -0.05),ncol=6)
	fileNameLoss = folderName +  'CNN_Mask5andMask10_loss_e'+str(epochs)+'.png'
	plt.savefig(fileNameLoss)

	names = ['CNN original with Kernel 3x3', 'CNN with Kernel 5x5', 'CNN with Kernel 10x10']
	...
	fileNameTestScores = folderName + 'CNN_Mask5andMask10_testScores_e'+str(epochs)+'.png'
	plt.savefig(fileNameTestScores)

#epochs = 20
epochs_list = [5,10,15,20]
folderName = "CNN_differentMask/"
